"""
Django settings for karmastat project.
...
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'django-insecure-mt@0dktyp+5m+raa=xpv2q901z-vu_b!&wz+q$ady0(b)n$rfv')
...
WSGI_APPLICATION = 'karmastat.wsgi.application'
